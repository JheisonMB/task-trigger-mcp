# install.ps1 — download and install canopy on Windows
# Usage: irm https://raw.githubusercontent.com/UniverLab/agent-canopy/main/scripts/install.ps1 | iex
#
# Options (set as env vars before running):
#   $env:VERSION    = "2.0.0"           # pin a specific version
...
# --- download ---
$Archive = "canopy-$Tag-$Target.zip"
$Url     = "https://github.com/$Repo/releases/download/$Tag/$Archive"
$Tmp     = Join-Path $env:TEMP "canopy-install"
